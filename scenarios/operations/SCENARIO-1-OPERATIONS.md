...
```bash
kubectl delete ingress datablue-direct-ingress -n datablue-test
kubectl delete svc backend-service-public echo-demo-svc -n datablue-test
kubectl delete deployment echo-demo -n datablue-test
```
