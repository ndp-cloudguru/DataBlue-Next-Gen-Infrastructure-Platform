...
Trường hợp không dùng lớp Proxy Entry Account (Account 2/3) mà Public dịch vụ trực tiếp từ cụm EKS bằng AWS Load Balancer Controller:

#### 1. Kiểm tra trạng thái AWS Load Balancer Controller
```bash
